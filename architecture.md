...
sequenceDiagram
    ...
    _DebouncedHandler->>asyncio: schedule delayed trigger
    ...
    Integrator->>CmdorcCommandLink: set_status(), update tooltips, set_output_path()
```
...
CI will fail if total coverage < 90%.
